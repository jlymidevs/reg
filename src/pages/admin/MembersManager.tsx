...
export default function MembersManager() {
        ...
        <div className="card overflow-hidden">
          <div className="bg-primary p-8 text-white">
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t border-white/20">
              <div>
                <p className="text-blue-300 text-xs uppercase tracking-wider mb-1">Registered</p>
                <p className="text-2xl font-bold">{selectedMember.total_events_registered} <span className="text-base font-normal text-blue-200">events</span></p>
              </div>
              <div>
                <p className="text-blue-300 text-xs uppercase tracking-wider mb-1">Attended</p>
              ...
              <div>
                <p className="text-blue-300 text-xs uppercase tracking-wider mb-1">Cancelled</p>
                ...
                <div key={historyItem.registration_id} className="bg-white p-5 rounded-xl border border-border shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div>
                    <span className={`badge ${
                      historyItem.status === 'registered' ? 'badge-primary' : 
                      historyItem.status === 'attended' ? 'badge-success' : 'badge-neutral'
                    }`}>
                      {historyItem.status}
                    </span>
                  </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-primary mb-2">Members Directory</h2>
        <p className="text-muted">View a complete list of attendees and their event history.</p>
      </div>

      <div className="flex bg-white p-4 rounded-xl shadow-sm border border-border">
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-xl font-medium text-text mb-2">No members found</h3>
